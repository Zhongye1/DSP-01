...
4. 要使一棵非空二叉树的先序序列与中序序列相同，其所有非叶结点须满足的条件是 0
...
6．已知字符集 $\{ { \mathsf { a } } , { \mathsf { b } } , { \mathsf { c } } , { \mathsf { d } } , { \mathsf { e } } , { \mathsf { f } } , { \mathsf { g } } , { \mathsf { h } } \}$ ，若各字符的哈夫曼编码依次是0100,10,0000,0101,001,011,11,0001，则编码序列0100011001001011110101 的译码结果是 。
...
12. 假定计算机Ml和M2具有相同的指令集体系结构CISA), 主频分别为 1.5GHz和1.2GHz。 在Ml和M2上运行某基准程序P, 若平均C PI分别为2和1, 则程序P在Ml和M2上运行时间的比值是 。
...
13. 机主存按字节编址， 由4个 $6 4 \mathbf { M } \times 8$ 位的DRAM芯片采用交叉编址方式构成，并与宽度为32位的存储器总线相连， 主存每次最多读写32位数据。 若double型变量 $\mathbf { x }$ 的主存地址为804 OOlAH, 则读取 $\mathbf { x }$ 需要的存储周期数是
...
![](images/5f0e8a2ebb2d3217697af45f20ec5518429c3510a4b9bd478ffc88915b577cec.jpg)
...
![](images/1bca2f566bc95e9ab3550abbed2f381005b976e37ff169dbd86644b4f31e19ce.jpg)  
(a)

![](images/f124d04b1c5eb1b3650f5f32447d504a0fa054365bfd9c6e8b1e0b46143a0429.jpg)  
(b)
