...
19. 减法指令“sub R1, R2, R3”的功能为“(R1) - (R2) → R3”，该指令执行后将生成进位/借位标志 CF 和溢出标志 OF。若 $(\mathrm{R}1) = \mathrm{FFFF}$ FFFFH， $(\mathrm{R}2) = \mathrm{FFFF}$ FFF0H，则该减法指令执行后，CF 与 OF 分别为
...
若优先权值大的进程优先获得 CPU，从 $T$ 时刻起系统开始进程调度，系统的平均周转时间为 ______。
...
![](images/afd0cee5bcc2a0ec8e7339ea5edea3613e7ab23f65dc343d4a5c751b214cc20f.jpg)
...
![](images/8557981c64dc7dd8a653b74c462ea9b7cab64c822a011f9b53ca1ffc43252b07.jpg)  
题44图
...
![](images/d1a285c15046d2d3ed681ef379bc03d631c0aa1884c872a33ddc94c040e058f7.jpg)  
题47图
